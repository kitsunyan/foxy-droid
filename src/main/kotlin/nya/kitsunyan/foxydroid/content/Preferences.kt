...
object Preferences {
  ...
  private val keys = sequenceOf(Key.AutoSync, Key.IncompatibleVersions, Key.RootInstalation, Key.ProxyHost, Key.ProxyPort, Key.ProxyType,
  ...
  sealed class Key<T>(val name: String, val default: Value<T>) {
    ...
    object RootInstalation : Key<Boolean>("root_installation",Value.BooleanValue(false))
